    ...
    <div class="container">
      <div class="news-wrapper">
        <div class="news-header">
          ...
          <nuxt-link :to="'/news'" >All news</nuxt-link>
        </div>
        <div class="row">
          <div class="col-xl-9 col-lg-9">
            <div class="row">
              <div v-for="item in card_1" :key="item.id" class="col-lg-4">
                <CardNews
                  type="card1"
                  :id="item.id"
                  :image="item.image"
          ...
          <div class="col-xl-3">
              <div class="news-right">
                  <div class="news-right-col" v-for="item in card_2" :key="item.id">
                      <CardNews 
                      type="card2"
                      :card2_title="item.title"
                      :card2_date="item.date"
                      :card2_nav="item.tag"
                      />
                  </div>
              </div>
      ...
      card_1: [
        {
          ...
          text: "Next round of competition for Research Excellence Program (REP) program will be announced in first quarter 2022.",
        },
        {
...
For all questions, please contact us, no later than 5 days before the deadline for submission of the application by e-mail: munis@mininnovation.uz .`,
      ...
      card_2: [
        {
          title:
            "A competition for an international scientific reviewer (Peer reviewers) is announced",
          date: "20.10.2021",
          tag: "the science",
        },
        {
          title: `In cooperation with the World Bank, the project "modernization of the national innovation system of Uzbekistan" is being developed.`,
          date: "20.10.2021",
          tag: "innovation",
        },
        {
          title: "The flag of Uzbekistan is thrown into the stratosphere",
          date: "20.10.2021",
          tag: "the science",
        },
        {
          title: `The minister of Innovation Development held talks with members of the International Expert Council of the World Bank project`,
          date: "20.10.2021",
          tag: "innovation",
        },
      ],
